...
public class GiaoDienChonGhe extends javax.swing.JFrame {
     ...
     */
          ...
          ArrayList <JTextField> listUnSelected = new ArrayList();
...
// viet thu tim ghe moi chon de xoa ra khoi danh sach
            for(int i =0;i < listSelected.size();i++){
                ...
                for(int j=0;j<listUnSelected.size();j++){
                    
                    System.err.println("chuan bi xoa");
                if(listSelected.get(i) == listUnSelected.get(j)){
...
private void changeColor(Color a){
 ...
 // test code 
  if (listSelected.size() == 0){
   ...
   if (listUnSelected.size() == 0){
              System.err.println("ds bo  chon trong");
